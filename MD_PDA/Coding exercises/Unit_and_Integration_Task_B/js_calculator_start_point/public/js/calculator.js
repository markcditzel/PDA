...
// *NEW* Need to implement a way to return NaN ERROR if dividing by 0
// Ensure that if zero entered results in Warning error / ELSE as normal
  divide: function(number){
    if(number === 0){
      this.runningTotal = "ERROR NaN";
    } else {
      this.runningTotal = parseFloat(this.previousTotal) / parseFloat(number);
    }
  },
